...
from u2d_msa_sdk.db.crud.base import MSARouterMixin
from u2d_msa_sdk.db.crud.schema import MSACRUDOut
from u2d_msa_sdk.db.crud.utils import schema_create_by_schema
from u2d_msa_sdk.admin.utils.functools import cached_property
...
class AuthRouter(MSARouterMixin):
    ...
    def __init__(self, auth: Auth = None):
        ...
        self.router.add_api_route(
            ...
            dependencies=None, response_model=MSACRUDOut[self.schema_user_info]
        )
        self.router.add_api_route(
            '/logout', self.route_logout, methods=["GET"], description=_('Sign out'),
            dependencies=None, response_model=MSACRUDOut
        )
        # oauth2
