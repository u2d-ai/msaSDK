...
def automate_mkdocs_from_docstring(
    ...
    with open(f'{mkgendocs_f}', 'r+') as mkgen_config:
        insert_string = ''
    ...
    with open(f'{mkgendocs_f}', 'w') as mkgen_config:
...
def automate_nav_structure(
    ...
    # print(structure)
    with open(f'{mkdocs_f}', 'r+') as mkgen_config:
        contents = mkgen_config.readlines()
        if match_string in contents[-1]:
            contents.append(insert_string)
        else:
    ...
    with open(f'{mkdocs_f}', 'w') as mkgen_config:
        mkgen_config.writelines(contents)
...
def main():
    ...
    python_tips_dir = Path.cwd().joinpath('u2d_msa_sdk')
    ...
    print("DONE automate_mkdocs_from_docstring")
    ...
    print("DONE automate_nav_structure")
