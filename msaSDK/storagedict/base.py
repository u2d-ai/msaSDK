...
class MSAConnectionStorageDict(MSAStorageDict, ABC):
    """Base for Dict classes that are connection oriented."""
    ...
    def __init__(self, keyspace, connection, *args, **kwargs):
        ...
        super(MSAConnectionStorageDict, self).__init__(*args, **kwargs)
