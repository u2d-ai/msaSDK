.. MSA SDK documentation master file, created by
   sphinx-quickstart on Fri Sep  9 12:44:48 2022.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

.. image:: msa_logo_big.png

Welcome to MSA SDK's documentation!
===================================

An usage example is in the app module __init__.py
